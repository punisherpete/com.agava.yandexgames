...
## [10.1.0] - 2023-18-01
### Added
- InAppPurchases.InitPayments - method to init Yandex IAP
- InAppPurchases.BuyItem(itemID, OnRewardedCallback, OnPaymentsFailedCallback) - method to perform IAP via Yandex.Games
